...
try {
  ...
  switch ($action) {
    ...
    case 'login': // Obsługa logowania switch 
      switch ($portal->login()) {
        case ACTION_OK:
    ...
    case 'registerUser':
      switch ($portal->registerUser()):
        ...
        return;
        case FORM_DATA_MISSING:
        $portal->setMessage('Proszę wypełnić wszystkie pola formularza!'); break;
        case PASSWORDS_DO_NOT_MATCH:
        $portal->setMessage('Hasło musi być takie samo w obu polach!'); break;
        case USER_NAME_ALREADY_EXISTS:
        $portal->setMessage('Podany adres e-email jest już zarejestrowany!'); break;
        case ACTION_FAILED:
        $portal->setMessage('Obecnie rejestracja nie jest możliwa.'); break;
        case SERVER_ERROR:
        default:
